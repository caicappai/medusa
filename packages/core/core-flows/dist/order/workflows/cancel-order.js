...
exports.cancelOrderWorkflow = (0, workflows_sdk_1.createWorkflow)(exports.cancelOrderWorkflowId, (input) => {
    ...
    (0, workflows_sdk_1.parallelize)((0, steps_2.deleteReservationsByLineItemsStep)(lineItemIds), (0, steps_1.cancelPaymentStep)({ paymentIds }), (0, cancel_orders_1.cancelOrdersStep)({ orderIds: [order.id] }), (0, common_1.emitEventStep)({
