...
describe("OrchestratorBuilder", () => {
    let builder;
    beforeEach(() => {
        builder = new orchestrator_builder_1.OrchestratorBuilder();
    });
    ...
    describe("Composing Complex Transactions", () => {
        ...
        it("should load a transaction and add two steps", () => {
            const builder = new orchestrator_builder_1.OrchestratorBuilder(loadedFlow);
            builder
        ...
        it("Fully compose a complex transaction", () => {
            const builder = new orchestrator_builder_1.OrchestratorBuilder();
            builder
                .addAction("step_1", { saveResponse: true })
                .addAction("step_2", { saveResponse: true })
