...
const convert_item_response_to_update_request_1 = require("../convert-item-response-to-update-request");
        ...
        const expectations = [
            {
                ...
                output: {
                    ...
                    relation_object_without_params_id: "test-relation-object-without-params-id",
                },
            },
        ];
        expectations.forEach((expectation) => {
            const response = (0, convert_item_response_to_update_request_1.convertItemResponseToUpdateRequest)(expectation.item, expectation.selects, expectation.relations);
