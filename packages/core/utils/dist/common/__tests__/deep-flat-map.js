...
const deep_flat_map_1 = require("../deep-flat-map");
describe("deepFlatMap", function () {
    it("should return flat map of nested objects", function () {
        ...
        const result = (0, deep_flat_map_1.deepFlatMap)(data, "stock_locations.fulfillment_sets.service_zones.shipping_options.calculated_price", ({ root_, stock_locations, fulfillment_sets, service_zones, shipping_options, calculated_price, }) => {
            return {
