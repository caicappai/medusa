...
const remote_query_object_from_string_1 = require("../remote-query-object-from-string");
const fields = [
    "id",
    "created_at",
    "updated_at",
...
describe("remoteQueryObjectFromString", function () {
    it("should return a remote query object", function () {
        const output = (0, remote_query_object_from_string_1.remoteQueryObjectFromString)({
            entryPoint: "product",
            variables: {
                q: "name",
                options: {
...
//# sourceMappingURL=remote-query-object-from-string.spec.js.map