...
const remote_query_object_to_string_1 = require("../remote-query-object-to-string");
...
describe("remoteQueryObjectToString", function () {
    it("should return a string array of fields/relations", function () {
        const output = (0, remote_query_object_to_string_1.remoteQueryObjectToString)(remoteQueryObject);
...
//# sourceMappingURL=remote-query-object-to-string.spec.js.map