...
const string_to_select_relation_object_1 = require("../string-to-select-relation-object");
const fields = [
    "id",
    "created_at",
    "updated_at",
...
describe("stringToSelectRelationObject", function () {
    it("should return an object containing the select and relation properties", function () {
        const output = (0, string_to_select_relation_object_1.stringToSelectRelationObject)(fields);
