...
declare class DeepRecursiveEntity1 {
    ...
    id: string;
    deleted_at: Date | null;
    entity3: Collection<DeepRecursiveEntity3, object>;
...
export { DeepRecursiveEntity1, DeepRecursiveEntity2, DeepRecursiveEntity3, DeepRecursiveEntity4, Entity1, Entity1WithUnDecoratedProp, Entity2, Entity2WithUnDecoratedProp, InternalCircularDependencyEntity1, Product, ProductOption, ProductOptionValue, ProductVariant, RecursiveEntity1, RecursiveEntity2, SearchableEntity1, SearchableEntity2, };
