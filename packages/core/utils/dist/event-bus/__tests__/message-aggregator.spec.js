...
const message_aggregator_1 = require("../message-aggregator");
describe("MessageAggregator", function () {
    afterEach(() => {
        jest.resetAllMocks;
    });
    it("should group messages by any given group of keys", function () {
        const aggregator = new message_aggregator_1.MessageAggregator();
        aggregator.save({
...
//# sourceMappingURL=message-aggregator.spec.js.map