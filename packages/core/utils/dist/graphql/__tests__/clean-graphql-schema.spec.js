...
const clean_graphql_1 = require("../clean-graphql");
describe("Clean Graphql Schema", function () {
    ...
    `;
        const { schema, notFound } = (0, clean_graphql_1.cleanGraphQLSchema)(schemaStr);
...
//# sourceMappingURL=clean-graphql-schema.spec.js.map