...
describe("Abstract Module Service Factory", () => {
    ...
    const medusaService = (0, medusa_service_1.MedusaService)({
        MainModelMock,
        OtherModelMock1,
        OtherModelMock2,
    });
    describe("Main Model Methods", () => {
        ...
        it("should have retrieve method", async () => {
            ...
            expect(containerMock.mainModelMockService.retrieve).toHaveBeenCalledWith("1", undefined, defaultContext);
        });
        it("should have list method", async () => {
            const result = await instance.listMainModelMocks();
            expect(result).toEqual([{ id: "1", name: "Item" }]);
            expect(containerMock.mainModelMockService.list).toHaveBeenCalledWith({}, {}, defaultContext);
        });
        it("should have delete method", async () => {
            await instance.deleteMainModelMocks("1");
            expect(containerMock.mainModelMockService.delete).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have softDelete method", async () => {
            const result = await instance.softDeleteMainModelMocks("1");
            expect(result).toEqual({});
            expect(containerMock.mainModelMockService.softDelete).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have restore method", async () => {
            const result = await instance.restoreMainModelMocks("1");
            expect(result).toEqual({});
            expect(containerMock.mainModelMockService.restore).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have delete method with selector", async () => {
            await instance.deleteMainModelMocks({ selector: { id: "1" } });
            expect(containerMock.mainModelMockService.delete).toHaveBeenCalledWith([{ selector: { id: "1" } }], defaultTransactionContext);
        });
    });
    describe("Other Models Methods", () => {
        ...
        it("should have retrieve method for other models", async () => {
            ...
            expect(result).toEqual({ id: "1", name: "Item" });
            expect(containerMock.otherModelMock1Service.retrieve).toHaveBeenCalledWith("1", undefined, defaultContext);
        });
        it("should have list method for other models", async () => {
            const result = await instance.listOtherModelMock1s();
            expect(result).toEqual([{ id: "1", name: "Item" }]);
            expect(containerMock.otherModelMock1Service.list).toHaveBeenCalledWith({}, {}, defaultContext);
        });
        it("should have delete method for other models", async () => {
            await instance.deleteOtherModelMock1s("1");
            expect(containerMock.otherModelMock1Service.delete).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have softDelete method for other models", async () => {
            const result = await instance.softDeleteOtherModelMock1s("1");
            expect(result).toEqual({});
            expect(containerMock.otherModelMock1Service.softDelete).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have restore method for other models", async () => {
            const result = await instance.restoreOtherModelMock1s("1");
            expect(result).toEqual({});
            expect(containerMock.otherModelMock1Service.restore).toHaveBeenCalledWith(["1"], defaultTransactionContext);
        });
        it("should have delete method for other models with selector", async () => {
            await instance.deleteOtherModelMock1s({ selector: { id: "1" } });
            expect(containerMock.otherModelMock1Service.delete).toHaveBeenCalledWith([{ selector: { id: "1" } }], defaultTransactionContext);
        });
    });
    describe("Custom configuration using DML", () => {
        ...
        const MockModel = dml_1.model.define("user", {
            id: dml_1.model.id().primaryKey(),
        });
        const MockModel2 = dml_1.model.define("car", {
            id: dml_1.model.id().primaryKey(),
        });
        const MockModel3 = dml_1.model.define("house", {
            id: dml_1.model.id().primaryKey(),
        });
        const medusaService = (0, medusa_service_1.MedusaService)({
            MockModel,
        ...
        it("should have the correct methods name while resolving the correct underlying service representation of target models", async () => {
            ...
            expect(result).toEqual({ id: "1", name: "Item" });
            expect(containerMock.userService.retrieve).toHaveBeenCalledWith("1", undefined, defaultContext);
            result = await instance.retrieveMockModel2("1");
            expect(result).toEqual({ id: "1", name: "Item" });
            expect(containerMock.carService.retrieve).toHaveBeenCalledWith("1", undefined, defaultContext);
            result = await instance.retrieveMockModel3("1");
            expect(result).toEqual({ id: "1", name: "Item" });
            expect(containerMock.houseService.retrieve).toHaveBeenCalledWith("1", undefined, defaultContext);
        });
    });
});
//# sourceMappingURL=medusa-service.spec.js.map