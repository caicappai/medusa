...
describe("Total calculation", function () {
    it("should calculate carts with items + taxes", function () {
        ...
        const serialized = JSON.parse(JSON.stringify((0, totals_1.decorateCartTotals)(cart)));
    ...
    it("should calculate carts with shipping_methods + items + taxes + discounts with is_tax_inclusive", function () {
        ...
        const serializedMixed = JSON.parse(JSON.stringify((0, totals_1.decorateCartTotals)(cartMixed)));
    ...
    it("should calculate carts with items + taxes with is_tax_inclusive", function () {
        ...
        const serializedWith = JSON.parse(JSON.stringify((0, totals_1.decorateCartTotals)(cartWithTax)));
        const serializedWithout = JSON.parse(JSON.stringify((0, totals_1.decorateCartTotals)(cartWithoutTax)));
        const serializedMixed = JSON.parse(JSON.stringify((0, totals_1.decorateCartTotals)(cartMixed)));
